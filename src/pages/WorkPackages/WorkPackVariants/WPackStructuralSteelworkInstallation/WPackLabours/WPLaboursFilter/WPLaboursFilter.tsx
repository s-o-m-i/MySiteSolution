  ...
  return (
    ...
    py={"10px"}
      ...
      >
        ...
        <Box width={"200px"} sx={{ backgroundColor: '#1D1D1D',borderRadius:'7px',cursor:"pointer"}} p={1}>
...
{showStatus && (    
        ...
        <Box width={"200px"} sx={{ backgroundColor: '#1D1D1D',borderRadius:'7px',cursor:"pointer"}} p={1} mt={'10px'}>
          ...
          <img onClick={()=>setShowStatus(!showStatus)} src="/images/general/atomdownarrow.svg" alt="" />
            </Box>
...
export default WPLaboursFilter;
